...
export default async function getRankingImage(guild: Guild): Promise<AttachmentBuilder | null> {
    try{
        ...
        for(let i = 0; i< users.length; i++){
            ...
            if(typeof item === 'string'){
                ...
                // Draws image (medal)
                ctx.drawImage(item, 140, topY + 15, 50, 50);
            }
